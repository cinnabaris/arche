...
CREATE UNIQUE INDEX uk_forum_permalinks_resource ON forum_permalinks(resource_id, resource_type);
CREATE UNIQUE INDEX uk_forum_permalinks_url ON forum_permalinks(url);
CREATE UNIQUE INDEX uk_forum_permalinks_resource_type ON forum_permalinks(resource_type);
